...
/*
 * the following is a HTML 5 specification email validator regex that can be used
 * to catch email addresses for "opensauced.pizza"
 */

export const opensaucedEmailRegex = new RegExp(/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@opensauced\.pizza$/);
